...
/**
 * Oggetto semplice contenente i dati relativi ad 
 * un singolo esame.
...
public class Esame {
	...
	/** 
	 * Restituisce il voto solo se l'esame è 
	 * stato superato, altrimenti genera una eccezione
	 * @return the voto
	 */
	public int getVoto() {
		if(this.superato) {
	...
	/**
	 * Restituisce il dataSuperamento solo se l'esame è 
	 * stato superato, altrimenti genera una eccezione
	 ...
	 * con il voto e data specificato
	 * Se fosse già superato, genera una eccezione.
	 * 
	 * @param voto
	 * @param data
	 */
